<h3>Filtro</h3>
					<div class="col-sm-3">
		{!!Form::open(Request::all(),['route'=>'admin.registro_jugador_equipos.index','method'=>'GET','class'=>'navbar-form navbar-left pull-right','role'=>'search'])!!}
				  <div class="form-group">
				    
				    {!!Form::text('nombreequipo',null,['class'=>'form-control','placeholder'=>'Nombre del equipo'])!!}
				  	  </div>
				  	   </div>
				 <div class="col-sm-3">
